...
/**
 * Represents the export story screen of the Paths Application.
 *
 * @author Tiago Brito.
 * @version 2023.05.21.
 */
public class ExportStoryScreen extends Screen {
  ...
  /**
   * Creates an instance of ExportStoryScreen.
   *
   ...
   */
  public ExportStoryScreen(PathsApp pathsApp, String title, Image backgroundImage, String subTitle,
                           List<Story> stories, String button1Text, String button2Text) {
    super("export_story_screen");
   ...
   * @throws IllegalArgumentException if the specified stories are null or empty.
   */
  ...
  public Scene createScene(PathsApp pathsApp) {
    ...
    chooseStoryScreenScene.getStylesheets().add(
        pathsApp.getClass().getResource("/css/export_story_screen.css").toExternalForm());
    ...
    storiesTableView.setOnMouseClicked(event -> {
      if (event.getClickCount() == 2) {
        ...
        ExportStoryScreenController exportStoryScreenController = (ExportStoryScreenController)
            pathsApp.getUserInterfaceManager()
                .getController("export_story_screen_controller");
        exportStoryScreenController.handleButton1Click(selectedStory);
      }
    });
    ...
    button2.setOnAction(event -> {
      ExportStoryScreenController exportStoryScreenController = (ExportStoryScreenController)
          pathsApp.getUserInterfaceManager()
              .getController("export_story_screen_controller");
      exportStoryScreenController.handleButton2Click();
    });
