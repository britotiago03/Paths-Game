...
/**
 * Represents the delete story screen of the Paths Application.
 *
 * @author Tiago Brito.
 * @version 2023.05.22.
 */
public class DeleteStoryScreen extends Screen {
  ...
  /**
   * Creates an instance of DeleteStoryScreen.
   *
   ...
   */
  public DeleteStoryScreen(PathsApp pathsApp, String title, Image backgroundImage, String subTitle,
                           List<Story> stories, String button1Text, String button2Text) {
    super("delete_story_screen");
  ...
  public Scene createScene(PathsApp pathsApp) {
    ...
    storiesTableView.setOnMouseClicked(event -> {
      if (event.getClickCount() == 2) {
        ...
        DeleteStoryScreenController deleteStoryScreenController = (DeleteStoryScreenController)
            pathsApp.getUserInterfaceManager()
                .getController("delete_story_screen_controller");
        deleteStoryScreenController.handleButton1Click(selectedStory, storiesTableView);
      }
    });
    ...
    button2.setOnAction(event -> {
      DeleteStoryScreenController deleteStoryScreenController = (DeleteStoryScreenController)
          pathsApp.getUserInterfaceManager()
              .getController("delete_story_screen_controller");
      deleteStoryScreenController.handleButton2Click();
    });
